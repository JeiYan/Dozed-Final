...
<form method="POST" action="success_create.php" class="ht-600 w-50">
        ...
        <div class="form-group"> 
            ...
            <input type="text" name="item_name" id="item_name" placeholder="Americano" required class="form-control <?php echo (!empty($itemname_err)) ? 'is-invalid' : ''; ?>" ><br>
        ...
        <div class="form-group">
            ...
            <select name="item_type" id="item_type" class="form-control placeholder="Select Item Type" <?php echo (!empty($itemtype_err)) ? 'is-invalid' : ''; ?>" required>
                ...
                <option value="Steak & Ribs">Milktea</option>
                <option value="Seafood">Frappucino</option>
                <option value="Pasta">Pasta</option>
                <option value="Lamb">Cold Brew</option>
                <option value="Chicken">Fruit Tea</option>
                <option value="Burgers & Sandwiches">Burgers & Sandwiches</option>
                <option value="Bar Bites">Cakes & Cookies</option>
                <option value="House Dessert">Hot Brew</option>
                <option value="Salad">Special Drinks</option>
                <option value="Shoney Kid">Add-Ons</option>
