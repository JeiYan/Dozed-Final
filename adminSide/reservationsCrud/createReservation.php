    ...
    <div class="wrapper">
        ...
        <form id="reservation-form" method="GET" action="availability.php" class="ht-600 w-50">
            <div class="form-group">
                ...
                <input class="form-control" type="date" id="reservation_date" name="reservation_date" min="<?= date('Y-m-d') ?>" required> <br>
            </div>
        ...
        <div id="insert-reservation-into-table"><br>
                    ...
                    <form id="reservation-form" method="POST" action="insertReservation.php" class="ht-600 w-50">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="customer_name" name="customer_name" class="form-control" required placeholder="Angelo Sudario"><br>
                        </div>
                        <?php
