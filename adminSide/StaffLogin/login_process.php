...
<head>
    ...
    body {
        text-align: center;
        padding: 40px 0;
        background: #f8f1e7; /* soft cream background */
        font-family: "Nunito Sans", "Helvetica Neue", sans-serif;
    }

    h1 {
        color: #6b4f3b; /* rich coffee brown */
        font-weight: 900;
        font-size: 40px;
        margin-bottom: 10px;
    }
    ...
    i.checkmark {
        color: #8BC34A; /* warm leafy green for success */
        font-size: 100px;
        line-height: 200px;
        margin-left: -15px;
    }
    ...
    .alert-success i {
        color: #689F38; /* darker green for icon */
    }
