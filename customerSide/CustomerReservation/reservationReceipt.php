...
if ($reservationInfo) {
    ...
    class PDF extends FPDF {
        function Header() {
            ...
            $logoText = "Dozed: Great Coffee | Good Coffee";
    ...
    $pdf->Cell(0, 10, 'Please present this receipt at the counter to verify your reservation and proceed to your payment.', 0, 'C');
