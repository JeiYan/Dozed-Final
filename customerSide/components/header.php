...
$result = mysqli_query($link, $query);
    ...
    if ($result) {
        ...
        if ($row) {
            ...
            echo "<a href='/dozed/customerSide/customerLogin/profile.php' title='View Profile' style='color: white; text-decoration: none;'>$member_name</a>";
            echo "<p class='logout-link' style='font-size:1.1em; margin-left:15px;padding:5px;color:white; '>$points Points </p>";
            echo "<p class='logout-link' style='font-size:1.1em; margin-left:15px;padding:5px; color:white; '>$vip_status";
    ...
    echo '<a class="logout-link" style="color: white; font-size:1.1em;" href="../customerLogin/logout.php">Logout</a>';
} else {
